 ...
 * @see com.avnet.alapps.model.gsfcreport.Customer
...
public class CustomerHome {
	...
	public Customer findById(java.math.BigDecimal id) {
		log.debug("getting Customer instance with id: " + id);
		try {
			Customer instance = (Customer) sessionFactory.getCurrentSession()
					.get("com.avnet.alapps.model.gsfcreport.Customer", id);
			if (instance == null) {
	...
	public List findByExample(Customer instance) {
		...
		try {
			List results = sessionFactory
					.getCurrentSession()
					.createCriteria(
							"com.avnet.alapps.model.gsfcreport.Customer")
