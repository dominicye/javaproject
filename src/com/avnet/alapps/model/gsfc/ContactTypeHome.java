 ...
 * @see com.avnet.alapps.model.gsfc.ContactType
	...
	public List findByExample(ContactType instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("com.avnet.alapps.model.gsfc.ContactType")
