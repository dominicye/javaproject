 ...
 * @see com.avnet.alapps.model.gsfc.Operation
...
public class OperationHome {
	...
	public Operation merge(Operation detachedInstance) {
		...
		try {
			Operation result = (Operation) sessionFactory.getCurrentSession()
	...
	public Operation findById(java.math.BigDecimal id) {
		log.debug("getting Operation instance with id: " + id);
		try {
			Operation instance = (Operation) sessionFactory.getCurrentSession()
					.get("com.avnet.alapps.model.gsfc.Operation", id);
			if (instance == null) {
	...
	public List findByExample(Operation instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("com.avnet.alapps.model.gsfc.Operation")
