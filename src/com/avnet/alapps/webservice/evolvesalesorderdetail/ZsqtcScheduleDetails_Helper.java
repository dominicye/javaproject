/**
 * ZsqtcScheduleDetails_Helper.java
 *
...
public class ZsqtcScheduleDetails_Helper {
    // Type metadata
    private static final com.ibm.ws.webservices.engine.description.TypeDesc typeDesc =
        new com.ibm.ws.webservices.engine.description.TypeDesc(ZsqtcScheduleDetails.class);
    ...
    static {
        ...
        field.setFieldName("reqDate");
        field.setXmlName(com.ibm.ws.webservices.engine.utils.QNameTable.createQName("", "ReqDate"));
        ...
        typeDesc.addFieldDesc(field);
        field = new com.ibm.ws.webservices.engine.description.ElementDesc();
        field.setFieldName("reqQty");
        field.setXmlName(com.ibm.ws.webservices.engine.utils.QNameTable.createQName("", "ReqQty"));
        ...
        typeDesc.addFieldDesc(field);
        field = new com.ibm.ws.webservices.engine.description.ElementDesc();
        field.setFieldName("confirQty");
        field.setXmlName(com.ibm.ws.webservices.engine.utils.QNameTable.createQName("", "ConfirQty"));
    ...
    public static com.ibm.ws.webservices.engine.encoding.Deserializer getDeserializer(
           ...
           javax.xml.namespace.QName xmlType) {
        return 
          new ZsqtcScheduleDetails_Deser(
            javaType, xmlType, typeDesc);
    };
