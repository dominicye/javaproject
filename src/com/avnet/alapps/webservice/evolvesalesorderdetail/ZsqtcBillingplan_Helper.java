...
public class ZsqtcBillingplan_Helper {
    // Type metadata
    private static final com.ibm.ws.webservices.engine.description.TypeDesc typeDesc =
        new com.ibm.ws.webservices.engine.description.TypeDesc(ZsqtcBillingplan.class);
    ...
    static {
        ...
        field.setFieldName("billingDate");
        field.setXmlName(com.ibm.ws.webservices.engine.utils.QNameTable.createQName("", "BillingDate"));
        ...
        typeDesc.addFieldDesc(field);
        field = new com.ibm.ws.webservices.engine.description.ElementDesc();
        field.setFieldName("billingAmount");
        field.setXmlName(com.ibm.ws.webservices.engine.utils.QNameTable.createQName("", "BillingAmount"));
        ...
        typeDesc.addFieldDesc(field);
        field = new com.ibm.ws.webservices.engine.description.ElementDesc();
        field.setFieldName("billingStatus");
        field.setXmlName(com.ibm.ws.webservices.engine.utils.QNameTable.createQName("", "BillingStatus"));
