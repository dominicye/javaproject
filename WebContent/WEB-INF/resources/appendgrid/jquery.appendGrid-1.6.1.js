    ...
    function insertRow(tbWhole, numOfRowOrRowArray, rowIndex, callerUniqueIndex) {
        ...
        for (var z = 0; z < numOfRow; z++) {
            ...
            if (settings.useSubPanel) {
                ...
                /////////////////////////TODO: Kens fix
                if ( $.isArray(numOfRowOrRowArray) && $.isFunction(settings.rowDataLoaded) ) {
                	for ( var rIdx = 0; rIdx < numOfRowOrRowArray.length; rIdx++) {
                		settings.rowDataLoaded(tbWhole, numOfRowOrRowArray[rIdx], addedRows[rIdx], uniqueIndex);
                	}
                }
                //////////////////////////
