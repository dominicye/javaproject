...
<c:set var="pageTitle" value="Component Type Attribute CRUD" scope="request" />
...
<html>
	<head>
		...
		<script type="text/javascript" src="${cp}/resources/js/systest/component_type_attr_crud.js?v=${jsdate}"></script>	
