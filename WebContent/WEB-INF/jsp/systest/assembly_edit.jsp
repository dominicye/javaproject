...
<c:set var="pageTitle" value="Assembly Editor" scope="request" />
...
<html>
	<head>
		...
		<script src="${cp}/resources/js/systest/assembly_edit.js?v=${jsdate}" type="text/javascript"></script>
	...
	<body>
		...
		<br>
		<strong>Chassis S/N: </strong> <input type="text" id="submitChassisSerialNum" name="submitChassisSerialNum" class="searchBox" value="${submitChassisSerialNum}"> 
		...
		<br><br>
		<form id="submitForm" name="submitForm" action="${cp}/systest/submitAssemblyEdit.htm" method="post">
			<input type="hidden" id="editChassisSerialNum" name="editChassisSerialNum" value="">
