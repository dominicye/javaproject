...
<c:set var="pageTitle" value="1st-Touch Assembly" scope="request" />
...
<html>
	<head>
		...
		<script src="${cp}/resources/js/systest/assembly_form.js?v=${jsdate}" type="text/javascript"></script>
	...
	<body>
		...
		<form id="submitForm" name="submitForm" action="${cp}/systest/submitAssembly.htm" method="post">
			...
			<input type="hidden" id="submitTouchLevel" name="submitTouchLevel" value="1">
